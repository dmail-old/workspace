...
const directoryIsEmpty = (directory) => new Promise((resolve, reject) => {
...
const copyTemplateIntoDirectory = (directory) => new Promise((resolve, reject) => {
...
const init = (directory) => directoryIsEmpty(directory).then(
  (isEmpty) => {
    if (isEmpty === false) {
